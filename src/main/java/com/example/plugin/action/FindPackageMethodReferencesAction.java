...
/**
 * 项目视图右键菜单：查找包内所有类的全部方法被引用的位置，导出 CSV。
 */
public class FindPackageMethodReferencesAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        CsvExporter.export(results, "pkg-method-refs", e.getProject());
    }
